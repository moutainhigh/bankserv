...
public class BankServiceImpl implements IBankService {
     ...
     * */
    @Override
    public String queryBalance(String packetHead, String request){
        String result="";
        ...
        operAttrStructMap.put("staffId",1);
        operAttrStructMap.put("operOrgId",1);
     ...
     * */
    @Override
    public String rechargeBalance(String packetHead, String param){
      ...
      /*  String content=param.substring(33,param.length()-1);//内容
        ...
        String resp="{" +
                "  \"acctBalanceId\": 660486228," +
                "  \"acctId\": 713025782517," +
                "  \"balanceTypeId\": 100016," +
                "  \"balanceTypeName\": \"预存\"," +
                "  \"bonusAmount\": 0," +
                "  \"effDate\": \"20000101\"," +
                "  \"endTime\": \"20200101\"," +
        ...
        String bankId=dom4jXml(bankIdXml,bankHead);
        String staffId=dom4jXml(staffIdXml,bankHead+areaId);
        if(bankId.equals("")||staffId.equals("")){
            result = packetHead.substring(0, 20) + String.format("%1$-10s", "49");//包头+包长度
            result+="120666#";
        }else{
            String row=bankDao.checkRowNum(content.substring(0,12),packetHead.substring(2,6),bankId);
     ...
     * 查询bankId
     * */
    public String queryBankId(String head){
        String result="";
        String code="";
        switch(head){
            //#光大银行
